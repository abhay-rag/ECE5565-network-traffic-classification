...
def data_preprocessing(file_name, csv_file_name):
    ...
    df['label'].loc[df['label'].str.contains("mirai", case=False, na=False)] = "Mirai"
    df['label'].loc[df['label'].str.contains("okiru", case=False, na=False)] = "okiru"
    df['label'].loc[df['label'].str.contains("torii", case=False, na=False)] = "torii"
    df['label'].loc[df['label'].str.contains("ddos", case=False, na=False)] = "DDoS"
    df['label'].loc[df['label'].str.contains("scan", case=False, na=False)] = "Part of Horizontal Scan"
    df['label'].loc[df['label'].str.contains("filedownload", case=False, na=False)] = "FileDownload"
    df['label'].loc[df['label'].str.contains("C&C", case=False, na=False)] = "C&C"
    df['label'].loc[df['label'].str.contains("heartbeat", case=False, na=False)] = "HeartBeat"
